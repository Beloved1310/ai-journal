    ...
    <>
      ...
      <section className="mt-32 flex flex-col justify-center gap-10">
        ...
        <form className="flex w-full flex-col justify-center gap-5">
          ...
          <button
            type="submit"
            className="font-poppins mx-auto w-2/3 whitespace-pre-line rounded-sm bg-gradient-to-br from-green-700 to-gray-800 py-3 text-xl font-bold text-gray-50 md:w-1/2"
          >Finish</button>
        </form>
      </section>
    </>
