...
export const AIRounter = createTRPCRouter({
  rateEntry: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const prompt =
        "Do sentiment analysis on the following statement between 1 and 10, 1 being negative and 10 being positive, return the number";
